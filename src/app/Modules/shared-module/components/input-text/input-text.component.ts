...
@Component({
  ...
  standalone: true,
  imports: [TuiInputModule, TuiErrorModule, ReactiveFormsModule, NgIf , NgFor, TuiInputPasswordModule]
})
export class InputTextComponent implements ControlValueAccessor {
  ...
  get errorList(): string[]{
    ...
    for (const key of Object.keys(this.inputControl.errors)) {
      if(key =='maxlength'){
        messages.push(GetValidationMessage(key,params,this.inputControl.errors?.maxlength?.requiredLength));
      }
      else{
